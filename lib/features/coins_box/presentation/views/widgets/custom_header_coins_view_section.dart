...
class CustomHeaderCoinsViewSection extends StatelessWidget {
  const CustomHeaderCoinsViewSection({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const TextWithAlignAndPaddingComponent(text: 'الصناديق الاستثمارية'),
      ],
    );
  }
}
