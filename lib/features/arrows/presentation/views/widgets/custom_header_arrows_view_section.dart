...
class CustomHeaderArrowsViewSection extends StatelessWidget {
  const CustomHeaderArrowsViewSection({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const TextWithAlignAndPaddingComponent(text: 'الاسهم'),
      ],
    );
  }
}
