...
class CustomHeaderMoneyViewSection extends StatelessWidget {
  const CustomHeaderMoneyViewSection({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const TextWithAlignAndPaddingComponent(text: 'المال'),
      ],
    );
  }
}
